...
회전은 설치 방위와 INS 의 자세 · 위경도가, 이동은 레버암과 INS 의 배 위치가 공급합니다. 이 구분이 그대로 오차의 출처 목록이 됩니다. 표기를 하나 짚고 가면, C_ned←body 는 동체 좌표를 NED 좌표로 바꾸는 회전행렬이고 화살표 방향이 곧 변환 방향입니다. 거꾸로 갈 때는 전치를 곱합니다.
