...
SLIDES_PDF = os.path.join(OUT_DIR, "Chapter2_coordinate_systems.pdf")
SCRIPT_MD = os.path.join(OUT_DIR, "Chapter2_발표대본.md")
COMBO_PDF = os.path.join(OUT_DIR, "Chapter2_발표자료_대본합본.pdf")

TITLE = "Chapter 2 좌표계와 좌표변환"
